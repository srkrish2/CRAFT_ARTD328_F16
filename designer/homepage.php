      ...
      <?php
        if(count($designs)>0){
          ...
          foreach($designs as  $value){
            ...
            echo " <div style='padding-top:10px;padding-left:10px;'><strong>".htmlspecialchars($value['title'])."</strong></div> <div style='padding-left:10px;'>".htmlspecialchars($stage)."</div>";
            echo "<hr>";

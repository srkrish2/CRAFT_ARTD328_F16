...
$insertsql = "INSERT INTO `Feedback`(`WriterID`, `DesignID`, `version`, `content`, `start_time`, `end_time`, `mentor`) VALUES (?, ?, ?, ?, ?, ?, ?)";
 if($stmt=mysqli_prepare($conn,$insertsql))
  {
    mysqli_stmt_bind_param($stmt,"iiisiii",$writerid, $designid, $version, $fbktext, $start_time, $timespent, $mentor);
    mysqli_stmt_execute($stmt);   
    mysqli_stmt_close($stmt); 
  }
          ...
          <div class="panel-body">
            ...
            <form class="form" action='save_survey_history.php?mid=<?php echo $mid;?>&writerid=<?php echo $writerid;?>' name="survey" id="survey" method="post" enctype="multipart/form-data">
              ...
              <table class="table table-striped">
                ...
                <div >
                  <tr style="display: none;" class="form-group required" id="form-group-e2">
                    <th scope='row' style='width:25%'class="radio-label" ><label class="control-label" for='e2'>Evaluating the history</label></td>
                    <td style='width:12%' align="center" class="radio-cell"><input type="radio" class="radio-inline" name="e2" id="e2" checked="checked" value="0"></td>
              ...
              <table class="table table-striped">
                ...
                <div>
                  <tr class="form-group required" id="form-group-t_history" style="display: none;">
                    <th scope='row' style='width:40%' class="radio-label" ><label class="control-label" for='t_history'>Evaluating the history</label></td>
                    <td><input style='width:60%' type="text" class="text-inline" name="t_history" placeholder="ex. 10" id="t_history" value="0"></td>
                  </tr>
                </div>
                <div>
